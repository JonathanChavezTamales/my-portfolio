...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredExceptOptionals() {
    // Based on everyAttendeeIsConsidered, this adds an optional attendee C who has an all-day event. 
  ...
  public void everyAttendeeIsConsideredIncludingOptionals() {
    // Based on everyAttendeeIsConsidered, this adds an optional attendee C who has an event between 8:30 and 9:00. 
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0830AM, TIME_0900AM, true),
            Arrays.asList(PERSON_C)));
